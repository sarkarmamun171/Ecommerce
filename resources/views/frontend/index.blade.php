                ...
                <div class="featured-categorie-slider owl-carousel">
                    @foreach ( $categories as $category)
                        <div class="featured-item">
                            <div class="images">
                                <img style="width: 60%; margin:auto;" src="{{asset('uploads/category')}}/{{ $category->category_img }}" alt="">
                            </div>
                            <div class="text">
                                <h2>
                                    @if (Str::length($category->category_name) > 12)
                                        <a title="{{$category->category_name}}" href="{{route('category.products', $category->id)}}">
                        ...
                        <div class="highlight-wrap">
                            ...
                            @foreach ($products->take(3) as $product)
                                <div class="product-card">
                                    <div class="card-image">
                                        <div class="image">
                                            <img width="250" src="{{asset('uploads/product/preview')}}/{{ $product->preview }}" alt="">
                                        </div>
                                    </div>
                                    <div class="content">
                                        <h3>
