    ...
    <div class="page-wrapper">
        ...
        <div class="wpo-login-area">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <form class="wpo-accountWrapper" action="{{ route('customer.login.confirm') }}" method="POST">
                            @csrf
                            <div class="wpo-accountInfo">
                                <div class="wpo-accountInfoHeader">
                                    <a href="index.html"><img src="{{asset('frontend')}}/images/logo-2.svg" alt=""></a>
                                    <a class="wpo-accountBtn" href="{{ route('cutomer.register') }}">
                            ...
                            <div class="wpo-accountForm form-style">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        @if(session('notverified'))
                                            <strong class="text-danger">{{ session('notverified') }}</strong>
                                        @endif
                                        @error('email')
                                ...
                                <p class="subText">Don't have an account? <a href="{{ route('cutomer.register') }}">Create free
                                        account</a></p>
                            </div>
                        </form>
                    </div>
