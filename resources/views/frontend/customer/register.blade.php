                        ...
                        <form class="wpo-accountWrapper" action="{{ route('customer.store') }}" method="POST">
                            ...
                            <div class="wpo-accountInfo">
                                <div class="wpo-accountInfoHeader">
                                    ...
                                    <a class="wpo-accountBtn" href="{{ route('cutomer.login') }}">
                            ...
                            <div class="wpo-accountForm form-style">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            @enderror
                                            @if(session('verified'))
                                                <div class="alert alert-danger">{{ session('verified') }}</div>
                                            @endif
                                            <span class="input-group-btn">
                                ...
                                <p class="subText">Sign into your pages account <a href="{{ route('cutomer.login') }}">Login</a></p>
                            </div>
                        </form>
                    </div>
                </div>
