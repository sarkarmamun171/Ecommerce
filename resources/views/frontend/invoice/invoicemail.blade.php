                        ...
                        <tbody>
                          ...
                          <tr>
                            <td style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; text-align: left;">
                              Hello, {{ App\Models\Billing::where('order_id', $order_id)->first()->fname.''.
                                        App\Models\Billing::where('order_id', $order_id)->first()->lname}}
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; text-align: right;">
                              ...
                              <small>{{ App\Models\Order::where('order_id', $order_id)->first()->created_at->format('m-d-Y') }}</small>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                    <tbody>
                      ...
                      @foreach (App\Models\OrderProduct::where('order_id', $order_id)->get() as $product )
                        ...
                        <tr>
                          <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #ff0000;  line-height: 18px;  vertical-align: top; padding:10px 0;" class="article">{{ $product->rel_to_product->product_name }}</td>
                          <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;"><small>{{ $product->price }}</small></td>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                  {{$bill->fname}}<br>
                                  {{$bill->address}}<br>
                                  {{$bill->rel_to_city->name}}<br>
                                  {{$bill->rel_to_country->name}}<br>
                                  {{$bill->zip}}<br>
                                  {{$bill->phone}}
                                </td>
                              </tr>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                  ...
                                  {{$ship->rel_to_city->name}}-<br>
                                  {{$ship->zip}}<br>
                                  {{$ship->rel_to_country->name}}<br>
                                  {{$ship->rel_to_country->ship_phone}}
                                </td>
                              </tr>
                            </tbody>
                          </table>
