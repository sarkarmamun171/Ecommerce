    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{asset('backend/index.html')}}" class="brand-logo">
                                            ...
                                            <li>
                                                <div class="timeline-panel">
                                                    <div class="media mr-2">
                                                        <img alt="image" width="50" src="{{asset('uploads/user')}}/{{ Auth::user()->photo }}">
                                                    </div>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{route('category.trash')}}">Trash</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <li><a href="{{ route('orders') }}" class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-heart"></i>
                    ...
                    <li><a class="has-arrow ai-icon" href="{{ route('subscriber') }}" aria-expanded="false">
                            <i class="flaticon-381-layer-1"></i>
                            <span class="nav-text">Subscriber</span>
                        </a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="{{ route('role.manager') }}" aria-expanded="false">
                            <i class="flaticon-381-layer-1"></i>
                            <span class="nav-text">Role Manager</span>
                        </a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="{{ route('tag') }}" aria-expanded="false">
                            <i class="flaticon-381-layer-1"></i>
                            <span class="nav-text">Tags</span>
                        </a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="{{ route('faq.index') }}" aria-expanded="false">
                            <i class="flaticon-381-layer-1"></i>
